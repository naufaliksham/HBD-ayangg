...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Apr 9, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Sayanggku Sisil dari Naufal, aku langitkan semua doa terbaik saya untuk kamu sayanggku.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu mendapatkan bahagia yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan (menikahiku) xixi."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Semoga aku bisa selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
new TypeIt("#trims", {
  strings: ["Silvia Eka Safitri", " ", "❤️", " ", "Naufal Iksham"],
  startDelay: 500,
  speed: 5,
  loop: false,
  waitUntilVisible: true,
